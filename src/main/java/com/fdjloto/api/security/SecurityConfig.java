...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/swagger-ui/**", "/v3/api-docs/**", "/api/hello").permitAll() // ✅ Swagger accessible sans JWT
                        .requestMatchers("/api/protected/**", "/api/protected/userinfo/**").authenticated()  // Protégé par JWT
                        .anyRequest().authenticated()
                )
